...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<bundler-audit>.freeze, ["~> 0.6.1".freeze])
  s.add_development_dependency(%q<coveralls>.freeze, ["~> 0.8.22".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.8.0".freeze])
  s.add_development_dependency(%q<webmock>.freeze, ["~> 3.5.1".freeze])
